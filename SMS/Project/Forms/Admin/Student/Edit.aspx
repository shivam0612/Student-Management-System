<%@ Page Title="" Language="C#" Theme="Theme" MasterPageFile="~/Forms/masters/Admin.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Forms_Admin_Entity_Edit" %>
    ...
    <div class="Form">
        ...
        <!---------------------->
          <asp:Panel runat="server" ID="Panel2" HorizontalAlign="Center">
            <asp:ImageButton ID="profile" CssClass="profilepicture" runat="server"/>        
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <asp:Label ID="lblEmail" runat="server" Text="Address" AssociatedControlID="txtEmail" SkinID="lbl"></asp:Label>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtdob" runat="server" placeholder="Enter date of birth" SkinID="txt"></asp:TextBox>
        </div>

         <div class="form-group">
            <asp:Label ID="lblclass" runat="server" Text="class" AssociatedControlID="txtclass" SkinID="lbl"></asp:Label>
            <asp:TextBox ID="txtclass" runat="server" placeholder="class" SkinID="txt"></asp:TextBox>
        </div>
        ...
        <div class="form-group" style="text-align: center">
            <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" SkinID="btn" />
        </div>
