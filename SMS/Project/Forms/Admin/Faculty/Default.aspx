<%@ Page Title="" Theme="Theme" Language="C#" MasterPageFile="~/Forms/masters/Admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Forms_Admin_Entity_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminBody" runat="Server">
    <div class="Form">
        ...
        <asp:SqlDataSource ID="IndexDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Faculty]" ProviderName="System.Data.OleDb"></asp:SqlDataSource>
    </div>
</asp:Content>
