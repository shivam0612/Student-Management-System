...
public class FacultyDetails extends Activity {
    ...
    private static String SOAP_ACTION1 = "http://tempuri.org/facultydetail";
    private static String METHOD_NAME1 = "facultydetail";
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        ProgressDialog dialog = new ProgressDialog(FacultyDetails.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            for (int i = 0; i < parts.length; i++) {
                TableRow tr = new TableRow(FacultyDetails.this);

                String[] fields = parts[i].split(",");
                for (int j = 0; j < fields.length; j++) {
                    TextView tv = new TextView(FacultyDetails.this);
