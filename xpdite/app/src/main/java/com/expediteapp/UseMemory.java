...
public class UseMemory extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Header.setText("Select pic to update");
		...
		rotate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Bitmap bmaprotated; 
				bmaprotated = Bitmap.createBitmap(bmap, 0, 0, bmap.getWidth(),
						bmap.getHeight(), bmapMatrix, true);
				bmap=bmaprotated;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 3:
			...
			return true;
		case 4:
			intent = new Intent(new Intent(UseMemory.this,LoginActivity.class));
			intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
					| intent.FLAG_ACTIVITY_CLEAR_TOP
					| Intent.FLAG_ACTIVITY_SINGLE_TOP);
			startActivity(intent);
	...
	private class myTask extends AsyncTask<Void, Void, Void> {
		...
		ProgressDialog dialog = new ProgressDialog(UseMemory.this);
