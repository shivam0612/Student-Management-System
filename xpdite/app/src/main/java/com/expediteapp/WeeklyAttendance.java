...
public class WeeklyAttendance extends Activity {
    private static String NAMESPACE = "http://tempuri.org/";
    private static String SOAP_ACTION1 = "http://tempuri.org/attendanceweekly";
    private static String METHOD_NAME1 = "attendanceweekly";
    ...
    TableLayout tl;
    TextView t1;
    TextView id,name,status,clas,date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1 = (TextView) findViewById(R.id.txtRecords);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        ProgressDialog dialog = new ProgressDialog(WeeklyAttendance.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            for (int i = 0; i < parts.length; i++) {
                TableRow tr = new TableRow(WeeklyAttendance.this);
                if (i % 2 == 0)
                    tr.setBackgroundColor(getResources().getColor(R.color.silver));
                String[] fields = parts[i].split(",");
                for (int j = 0; j < fields.length; j++) {
                    TextView tv = new TextView(WeeklyAttendance.this);
